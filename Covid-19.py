...
result.to_excel('https://github.com/nooraliraeeji/Siemens/tree/main/output/Table1.xlsx',index=False)
...
result2.to_excel('https://github.com/nooraliraeeji/Siemens/tree/main/output/Table2.xlsx',index=False)
